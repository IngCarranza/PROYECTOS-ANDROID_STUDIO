...
public class DB extends SQLiteOpenHelper {
    ...
    private static final String SQLdb = "CREATE TABLE peliculas (id text, rev text, idPeliculas text, titulo text, " +
    ...
    public String administrar_amigos(String accion, String[] datos) {
        try {
            ...
            if (accion.equals("nuevo")) {
                sql = "INSERT INTO peliculas(id,rev,idPeliculas,titulo,sinopsis,duracion,actor,foto) VALUES('" + datos[0] + "','" + datos[1] + "', '" + datos[2] +
                ...
                sql = "UPDATE peliculas SET id='" + datos[0] + "', rev='" + datos[1] + "', titulo='" + datos[3] + "',sinopsis='" + datos[4] + "',duracion='" +
                        datos[5] + "',actor='" + datos[6] + "', foto='" + datos[7]+"' WHERE idPeliculas='" + datos[2] + "'";
            } else if (accion.equals("eliminar")) {
                sql = "DELETE FROM peliculas WHERE idPeliculas='" + datos[2] + "'";
            }
            db.execSQL(sql);
            return "ok";
        } catch (Exception e) {
